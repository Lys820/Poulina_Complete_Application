        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilialeName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnalysisRequests_AspNetUsers_AssignedToId",
                        column: x => x.AssignedToId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AnalysisRequests_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AnalysisRequests_Laboratories_LaboratoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_AnalysisRequests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deadlines_AnalysisRequests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "AnalysisRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Samples_AnalysisRequests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "AnalysisRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnalysisResults_AspNetUsers_RecordedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalysisRequests_AssignedToId",
                table: "AnalysisRequests",
                column: "AssignedToId");

            migrationBuilder.CreateIndex(
                name: "IX_AnalysisRequests_ClientId",
                table: "AnalysisRequests",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_AnalysisRequests_LaboratoryId",
                table: "AnalysisRequests",
                column: "LaboratoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalysisResults_RecordedById",
                table: "AnalysisResults",
                column: "RecordedById");
